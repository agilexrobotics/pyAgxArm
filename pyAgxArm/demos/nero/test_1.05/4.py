...
# 测试结论：
# move_j模式下，0x2A1有反馈到达。机械臂运动中时，web端显示到达，机械臂实际到达时，web端显示未到达,可能是web端状态判断搞反了